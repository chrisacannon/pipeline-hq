...
Live: *(pending — the app will be published via GitHub Pages from this private repo; the checkpoint CSV and a couple of reference files with real personal data stay out of what gets published)*
...
* This repo is private. `checkpoints/` and `reference/app-tracker-live.html` contain real personal application data (including third-party contact info from recruiters) and are not meant to be published anywhere — they stay out of the public Pages site by design.
